                  ...
                  <div class="card-body" style="width:100%">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr class="table-info" >
                          ...
                          <td>{{$product-> photo}}</td>
                          <td>
                              <a href="/products/{{$product-> product_ID}}"><button class="tweet-button">Show</button></a>
                              <a href="/products/{{$product-> product_ID}}/edit"><button class="tweet-button" style="background-color: yellow">Edit</button></a>
                              <form method="POST" action="/products/{{$product-> product_ID}}">
                              @csrf
                              @method("DELETE")
                              <button class="tweet-button" style="background-color: red; margin-left: 30px" type="submit" >Delete</button>
                              </form>
                          </td>
                        </tr>
                        @endforeach
